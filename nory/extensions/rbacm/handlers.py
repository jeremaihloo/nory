...
from extensions.rbacm.models import Role, Menu, UserRoleMappings, UserGroup, PageDisplay, FileEntry, \
...
# ----------------------------------role----------------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_role', 'api_create_role')
@post('/api/roles')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_roles', 'api_get_roles')
@get('/api/roles')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_user_role_mappings', 'api_create_user_role_mappings')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_user_group', 'api_create_user_group')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_user_groups', 'api_get_user_groups')
@get('/api/user-groups')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_user_group_mapping', 'api_create_user_group_mapping')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_user_group_role_mapping', 'api_create_user_group_role_mapping')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_permission', 'api_create_permission')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_permissions', 'api_get_permissions')
@get('/api/permissions')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_permission_role_mapping', 'api_create_permission_role_mapping')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_menu', 'api_create_menu')
@post('/api/menus')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_menus', 'api_get_menus')
@get('/api/menus')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_permission_menu_mapping', 'api_create_permission_menu_mapping')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_page_display', 'api_create_page_display')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_permission_page_display', 'api_create_permission_page_display')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_page_displays', 'api_get_page_displays')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_file_entry', 'api_create_file_entry')
@post('/api/file-entry')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_page_file_entries', 'api_get_page_file_entries')
@get('/api/page-displays')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_permission_file_entry', 'api_create_permission_file_entry')
...
# -----------------------------------user-group---------------------------
@feature(features.__FEATURE_ROUTING__, 'api_create_operation', 'api_create_operation')
@post('/api/operations')
...
@feature(features.__FEATURE_ROUTING__, 'api_get_page_operation', 'api_get_page_operation')
@get('/api/operations')
...
@feature(features.__FEATURE_ROUTING__, 'api_create_permission_operation', 'api_create_permission_operation')

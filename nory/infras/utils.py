...
def nameof(obj):
    ...
    return getattr(obj, '__name__') if name is None else name


def scopeof(obj):
    scope = getattr(obj, 'scope', None)
    return getattr(obj, '__scope__') if scope is None else scope

def descriptionof(obj):
    desc = getattr(obj, 'description', None)
    return getattr(obj, '__description__') if desc is None else desc